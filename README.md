# ⚡ py-face-attendance-system — Enterprise AI Attendance Engine
...
**py-face-attendance-system** is a smart, real-time AI facial recognition attendance system designed for seamless access control and duration tracking. Built with **OpenCV (LBPH Recognizer)**, **Streamlit**, and **SQLite**, it provides dual-role access control, live facial sampling, automatic check-in/check-out time calculations, and real-time analytical dashboards.
